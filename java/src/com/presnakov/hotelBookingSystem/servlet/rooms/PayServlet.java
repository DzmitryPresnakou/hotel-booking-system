...
public class PayServlet extends HttpServlet {
    ...
    private final String ROOM_STATUS_BOOKED = "BOOKED";
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        CreateOrderDto createOrderDto = CreateOrderDto.builder()
                ...
                .orderStatus(orderStatusService.findByStatus(ORDER_STATUS_APPROVED).getId())
                .paymentStatus(paymentStatusService.findByStatus(PAYMENT_STATUS_APPROVED).getId())
        ...
        CreateRoomDto roomDto = CreateRoomDto.builder()
                ...
                .roomStatusDto(roomStatusService.findByStatus(ROOM_STATUS_BOOKED).getId())
